...
#'
#' @description
#' This function generates an image file of the potential last frame (in the first loop) in the .mp4 file that would be generated by generate_mp4().
...
last_frame <- function(input_function = NULL, bound = 2, step_size = .002, freq = 4){
  ...
  for(i in 1:length(x_vals)){
    ...
    # If the index is equal to that of the final frame, we plot and end the loop.
    if((i-1) %% freq == 0 && i >= end - freq){
      ...
      # Generate the plot for the last frame
